#usr/bin/bash
xdg-open https://www.tiktok.com/@hozoo54?_t=8gR3NQtN6PZ&_r=1
clear
bi='\033[34;1m' #biru
i='\033[32;1m' #ijo
...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" HOZOO [FR13ND8]"$i"          |"
echo $i" |"$pu" TIKTOK :"$ku"HACKERSHOZOO"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.hozoo] [MR.spokybunndy] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [HACKERSHOZOO]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" "$i"             085835787069|"
echo $i" |"$pu" TIKTOK :"$ku" HACKERSHOZOO"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $cy"JANGAN LUPA FOLLOW TIKTOK GW BRO "
sleep 2
echo $i" JANGAN LUPA SUBCRIBE LIKE KOMENTAR HACKERSHOZOO"
sleep 2
echo $i" jaman era bjroka menyerang data data kominfo dan data sambo dulu bjroka viral abis iti bjoka telah pensi lalu saya di gantikan lord HACKERSHOZOO dan saya berhasil retas data data nasa dan juga saya meretas ktp china ............."
sleep 2
echo $ku"WhatsApp :"$i" 08999859595"
echo $ku"YOUTUBE :"$i" HACKERSHOZOO"
echo $ku"🥲:"$i" jangan lupa suprot saya plis ges dukung saya plisss........." 
sleep 2
echo $pur">> MAKASI YAH LORD HOZOO  <<"
exit
fi